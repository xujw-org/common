#!/bin/bash
# https://github.com/xujw-org/build-actions
...
if [[ -n "${BENDI_VERSION}" ]]; then
  ...
  sudo rm -rf build/common && git clone -b main --depth 1 https://github.com/xujw-org/common build/common
...
git clone -b main --depth 1 https://github.com/xujw-org/build-actions shangyou
...
if [[ "${GIT_REPOSITORY}" =~ (xujw-org/build-actions|xujw-org/autobuild) ]]; then
  rm -rf backups
...
curl -fsSL https://raw.githubusercontent.com/xujw-org/common/main/common.sh -o common.sh
if [[ $? -ne 0 ]]; then
  wget -q https://raw.githubusercontent.com/xujw-org/common/main/common.sh -O common.sh
fi
...
if [[ -n "${BENDI_VERSION}" ]]; then
  ...
  export GIT_REPOSITORY="xujw-org/build-actions"
  sudo rm -rf build common.sh
